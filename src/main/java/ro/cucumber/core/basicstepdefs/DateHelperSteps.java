...
public class DateHelperSteps {
    ...
    @Given("Date pattern=\"{cstring}\"")
    public void format(String pattern) {
        this.formatter = DateTimeFormatter.ofPattern(pattern);
    }

    @Then("Date check period between \"{cstring}\" and \"{cstring}\" is {int}year(s)")
    ...
    @Then("Date check period between \"{cstring}\" and \"{cstring}\" is {int}day(s)")
    ...
    @Then("Date check period between \"{cstring}\" and \"{cstring}\" is {long}hour(s)")
    ...
    @Then("Date check period between \"{cstring}\" and \"{cstring}\" is {long}minute(s)")
    ...
    @Then("Date check period between \"{cstring}\" and \"{cstring}\" is {long}second(s)")
