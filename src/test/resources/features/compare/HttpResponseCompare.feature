Feature: Compare HTTP Responses
  ...
  Scenario: Compare HTTP responses with json body
    ...
    Then Negative Http Response compare #[a] against #[b] with json body, via jsonNonExtensibleObject=false, jsonNonExtensibleArray=true, jsonArrayStrictOrder=false, xmlChildListLength=false, xmlChildListSequence=false, xmlElementNumAttributes=false and message=[_null]
    ...
    """
    Then Negative Http Response compare #[a] against #[b] with json body, via jsonNonExtensibleObject=false, jsonNonExtensibleArray=false, jsonArrayStrictOrder=true, xmlChildListLength=false, xmlChildListSequence=false, xmlElementNumAttributes=false and message=[_null]
  ...
  Scenario: Compare HTTP responses with xml body
    ...
    Then Negative Http Response compare #[a] against #[b] with xml body, via jsonNonExtensibleObject=false, jsonNonExtensibleArray=false, jsonArrayStrictOrder=false, xmlChildListLength=false, xmlChildListSequence=true, xmlElementNumAttributes=false and message=[_null]
