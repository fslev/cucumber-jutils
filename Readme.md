...
_Under the hood_: If your Cucumber step definition uses anonymous parameter types ***{}***, then any **#[**_<property_name>_**]** sequence is parsed and the corresponding value is mapped to the corresponding argument:     
```
